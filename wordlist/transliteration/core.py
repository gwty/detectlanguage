...
import string
from  normalizer import core as core
#from  normalizer.core import Normalizer as normalizer
#from  normalizer.core import getInstance
...
class Transliterator:
    ...
    def __init__(self):
        global normalizer
        self.cmu = CMUDict()
        self.normalizer = core.getInstance()
        normalizer= core.getInstance()
